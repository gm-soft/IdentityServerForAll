    ...
    public class DeviceController : Controller
    {
            ...
            DeviceAuthorizationInputModel model)
        {
                    ...
                    model.ScopesConsented.Any())
                {
                    ...
                    if (!ConsentOptions.EnableOfflineAccess == false)
                    {
                        scopes = scopes.Where(x =>
                            x != IdentityServer4.IdentityServerConstants
            ...
            else
            {
                ...
                result.ViewModel =
                    await BuildViewModelAsync(model.UserCode, model);
            }
        ...
        {
            var request =
                await _interaction.GetAuthorizationContextAsync(userCode);
            if (request != null)
            {
            ...
            DeviceFlowAuthorizationRequest request)
        {
            ...
            vm.IdentityScopes = request.ValidatedResources.Resources
                .IdentityResources.Select(x => CreateScopeViewModel(
                    x, vm.ScopesConsented.Contains(x.Name) || model == null))
                .ToArray();
        ...
        private ScopeViewModel GetOfflineAccessScope(bool check)
        {
            ...
            {
                Value =
                    IdentityServer4.IdentityServerConstants.StandardScopes
                        .OfflineAccess,
